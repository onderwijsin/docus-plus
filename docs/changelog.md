...
[`content.config.ts`](../content.config.ts). It uses `type: "data"` and includes
`content/changelog/**/*.md` from the consuming application. Changelog entries deliberately do not
have individual routes: [`app/pages/changelog.vue`](../app/pages/changelog.vue) queries the entire
