...
The source can be a local file below `public/` or an absolute HTTPS URL. Parsing occurs during the
Nuxt Content build, validates the document, and rejects unsupported external `$ref` references.
